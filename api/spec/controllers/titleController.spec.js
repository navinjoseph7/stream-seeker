...
//   //     const req = {
//   //       params: {
//   //         id: 10528 , // Replace with a valid movie id
//   //       },
//   //     };
//   //     const res = {
...
//       const req = {
//         params: {
//           title: 'Sherlock Holmes' // Replace with a valid movie title
//         },
//       };
//       const res = {
//         status: jest.fn().mockReturnThis(),
...
// describe('FindByTitle mock', () => {
//   it('should return movie information when given a valid title', async () => {
//     // Mock the fetch response
//     const responseData = {
//       results: [
//         // Your mock movie data here
//       ],
//     };
...
//     expect(fetchMock).toHaveBeenCalledWith(expect.stringContaining('Sherlock Holmes'));
//     expect(res.status).toHaveBeenCalledWith(200);
//     expect(res.json).toHaveBeenCalledWith(responseData.results);
//   });
// });
